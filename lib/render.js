...
const SITE_NAME = 'FlixHdKino';
const DEFAULT_TITLE = 'FlixHdKino | Filme und Serien Kostenlos in HD online anschauen auf Deutsch';
const DEFAULT_DESC = 'Immer den schnellsten Stream online anschauen. FlixHdKino - HD Filme 2026 und Serien Kostenlos!';
const DEFAULT_OG_IMAGE = 'https://placehold.co/1200x630/17171b/8d8a92?text=FlixHdKino';
...
<header>
  <div class="header-inner">
    <a class="logo" href="/movie">FlixHd<span>Kino</span></a>
    <nav class="tabs">
...
<footer>
  <p>FlixHdKino — Film- und Serieninfos auf Basis öffentlicher TMDB-Daten (kein Streaming-Dienst) · Powered by <a href="https://www.themoviedb.org/" target="_blank" rel="noopener">TMDB</a></p>
  ${histatsSnippet()}
</footer>
